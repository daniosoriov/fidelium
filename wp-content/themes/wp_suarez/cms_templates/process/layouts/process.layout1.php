    ...
    <ul class="cshero-process-holder clearfix">
        ...
        <li class="cshero-process-outer item-last">
            <<?php echo $title_heading_size;?> class="cshero-process-title">
                ...
                <span style="line-height: <?php echo $icon_font_size; ?>; margin: <?php $title_margin; ?>; color: <?php echo $title_color; ?>;"><?php echo esc_attr($title5); ?></span>
            </<?php echo $title_heading_size;?>>
            <div class="cshero-process-text-holder">
        ...
        <li class="cshero-process-outer item-last">
            <<?php echo $title_heading_size;?> class="cshero-process-title">
                ...
                <span style="line-height: <?php echo $icon_font_size; ?>; margin: <?php $title_margin; ?>; color: <?php echo $title_color; ?>;"><?php echo esc_attr($title6); ?></span>
            </<?php echo $title_heading_size;?>>
            <div class="cshero-process-text-holder">
                <div class="cshero-process-text"><?php echo esc_attr($desc6); ?></div>
            </div>
        </li>
        <?php endif; ?>
        <?php if($icon7): ?>
        <li class="cshero-process-outer item-last">
            <<?php echo $title_heading_size;?> class="cshero-process-title">
                ...
                <span style="line-height: <?php echo $icon_font_size; ?>; margin: <?php $title_margin; ?>; color: <?php echo $title_color; ?>;"><?php echo esc_attr($title7); ?></span>
            </<?php echo $title_heading_size;?>>
            <div class="cshero-process-text-holder">
                <div class="cshero-process-text"><?php echo esc_attr($desc7); ?></div>
            </div>
        </li>
        <?php endif; ?>
        <?php if($icon8): ?>
        <li class="cshero-process-outer item-last">
            <<?php echo $title_heading_size;?> class="cshero-process-title">
                ...
                <span style="line-height: <?php echo $icon_font_size; ?>; margin: <?php $title_margin; ?>; color: <?php echo $title_color; ?>;"><?php echo esc_attr($title8); ?></span>
            </<?php echo $title_heading_size;?>>
            <div class="cshero-process-text-holder">
                <div class="cshero-process-text"><?php echo esc_attr($desc8); ?></div>
            </div>
        </li>
        <?php endif; ?>

<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <div class="cs-pricing-button" <?php if($custom['is_feature'][0] == 1) { echo 'style="background:'.$content_background_pricing_color.';"'; } ?>>
        <a <?php if($custom['is_feature'][0] == 1) { echo 'style="background:'.$button_background_pricing_color.';color:'.$button_font_pricing_color.';"'; } ?> title="<?php get_the_title() ?>" href="<?php echo esc_url($custom['button_url'][0]); ?>" rel="" class="btn <?php echo $button_type;?>"><?php echo $custom['button_text'][0]; ?></a>
    </div>
</article>
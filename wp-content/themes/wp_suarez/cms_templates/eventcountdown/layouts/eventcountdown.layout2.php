<div class="cs-eventCount">
	...
	<div class="cs-eventCount-content">
		...
		<div class="cs-eventCount-contentWrap col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<span id="event_countdown" class="" data-count="<?php echo date('Y-m-d H:i:s', $time_next); ?>" data-label="<?php echo __('DAYS', 'wp_suarez').','.__('HOURS', 'wp_suarez').','.__('MINUTES', 'wp_suarez').','.__('SECONDS', 'wp_suarez'); ?>" data-style="<?php echo esc_attr($number_position); ?>" ></span>
		</div>
		<?php endwhile; ?>
	</div>
</div>
...
function cshero_paging_nav() {
	...
	$links = paginate_links( array(
			...
			'prev_text' => __( '&larr; Previous', 'wp_suarez' ),
			'next_text' => __( 'Next &rarr;', 'wp_suarez' ),
	) );
...
function cshero_post_nav() {
	...
	<nav class="navigation post-navigation clearfix" role="navigation">
		<div class="nav-links">
			<?php
				previous_post_link( '<div class="nav-previous">%link</div>', _x( '<i class="fa fa-chevron-left"></i>BACK', 'wp_suarez' ) );
				next_post_link(     '<div class="nav-next">%link</div>',     _x( 'NEXT<i class="fa fa-chevron-right"></i>', 'wp_suarez' ) );
			?>
		</div><!-- .nav-links -->
	</nav><!-- .navigation -->
	<?php
...
function cshero_posted_on() {
	...
	$posted_on = sprintf(
		_x( 'Posted on %s', 'post date', 'wp_suarez' ),
		'<a href="' . esc_url( get_permalink() ) . '" rel="bookmark">' . $time_string . '</a>'
	);

	$byline = sprintf(
		_x( 'by %s', 'post author', 'wp_suarez' ),

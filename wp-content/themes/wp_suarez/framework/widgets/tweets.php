...
class CS_Tweets_Widget extends WP_Widget {
	...
	function __construct() {
        ...
        parent::__construct(
            'cs-tweets-widget', // Base ID
            esc_html__('CS Twitter', 'wp_suarez'), // Name
            $widget_ops, // Args
            $control_ops
        );
    }
	...
	function form($instance)
	{
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('show_date'); ?>" class="widefat" name="<?php echo $this->get_field_name('show_date'); ?>">
				<option value="no" <?php if($instance['show_date'] == 'no'){ echo "selected='selected'"; } ?>><?php echo __('No','wp_suarez'); ?></option>
				<option value="yes" <?php if($instance['show_date'] == 'yes'){ echo "selected='selected'"; } ?>><?php echo __('Yes','wp_suarez'); ?></option>
			</select>
		</p>

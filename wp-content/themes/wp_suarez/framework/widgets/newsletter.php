...
class NewsletterCustomWidget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
            'NewsletterCustom', // Base ID
            esc_html__('NewsletterCustom', 'wp_suarez'), // Name
            array('description' => esc_html__('Newsletter widget to add subscription forms on sidebars', 'wp_suarez')), // Args
            array('width' => '350px')
        );
    }

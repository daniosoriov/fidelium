...
class WC_Widget_Cart_Search extends WP_Widget {
    public function __construct() {
        parent::__construct(
            ...
            __('Cart & Search', 'wp_suarez'), // Name
            array('description' => __("Display the user's Cart and Search form in the sidebar.", 'wp_suarez'),) // Args
        );
    ...
    function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('title')); ?>"><?php _e( 'Title:', 'wp_suarez' ); ?></label>
            <input id="<?php echo esc_attr( $this->get_field_id('title') ); ?>" name="<?php echo esc_attr( $this->get_field_name('title') ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
        </p>
        <p>
            <label for="<?php echo esc_url($this->get_field_id('show_cart')); ?>"><?php _e( 'Show Cart:', 'wp_suarez' ); ?></label>
            <select id="<?php echo $this->get_field_id('show_cart'); ?>" class="widefat" name="<?php echo $this->get_field_name('show_cart'); ?>">
                <option value="0" <?php selected($show_cart,0); ?>><?php echo __('No','wp_suarez'); ?></option>
                <option value="1" <?php selected($show_cart,1); ?>><?php echo __('Yes','wp_suarez'); ?></option>
            </select>
        </p>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('show_search')); ?>"><?php _e( 'Show Search:', 'wp_suarez' ); ?></label>
            <select id="<?php echo $this->get_field_id('show_search'); ?>" class="widefat" name="<?php echo $this->get_field_name('show_search'); ?>">
                <option value="0" <?php selected($show_search,0); ?>><?php echo __('No','wp_suarez'); ?></option>
                <option value="1" <?php selected($show_search,1); ?>><?php echo __('Yes','wp_suarez'); ?></option>
            </select>
        </p>
    <?php
    }

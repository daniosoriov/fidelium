...
$enable_header_setting = get_post_meta($page_id, 'cs_header_setting', true);

$header3_menu_left_position = 'right';
if($enable_header_setting){
    $header3_menu_left_position = get_post_meta($c_pageID, 'cs_header3_menu_left_position', true);
    if(empty($header3_menu_left_position) || $header3_menu_left_position=='none' ) $header3_menu_left_position = 'right';
}

$header3_menu_right_position = 'left';
if($enable_header_setting){
    $header3_menu_right_position = get_post_meta($c_pageID, 'cs_header3_menu_right_position', true);
    if(empty($header3_menu_right_position) || $header3_menu_right_position=='none') $header3_menu_right_position = 'left';
}
/** data parallax */

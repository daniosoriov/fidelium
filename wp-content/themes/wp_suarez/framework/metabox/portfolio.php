...
function cshero_portfolio_metabox_general(){
    ...
    cs_options(array(
        ...
        'label' => __('Gallery Layout','wp_suarez'),
        'type' => 'select',
        'options' => array(
            ''=> 'Default',
            'carousel' => 'Carousel',
    ...
    cs_options(array(
        ...
        'label' => __('About Project','wp_suarez'),
        'type' => 'textarea',
    ));
    cs_options(array(
        'id' => 'portfolio_project_date',
        'label' => __('Project Date','wp_suarez'),
        'type' => 'date',
        'format' => 'M d Y'
    ));
    cs_options(array(
        'id' => 'portfolio_project_client',
        'label' => __('Project Client','wp_suarez'),
        'type' => 'textarea',
    ));
    if(function_exists('get_categories_assoc')){      
        ...
        cs_options(array(
            ...
            'label' => __('Similar Projects','wp_suarez'),
            'type' => 'multiple',
...
function cshero_portfolio_metabox_tab_title() {
    ?>
    <li class='cs-tab'><a href="#tabs-gallery"><i class="dashicons dashicons-images-alt2"></i> <?php echo _e('GALLERY', 'wp_suarez');?></a></li>
    <?php
}

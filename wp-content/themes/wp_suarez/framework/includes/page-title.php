...
if(is_page() && isset($post->ID)){ 
    ...
    //$breadcrumb = ($breadcrumb_enable != '0') ? $breadcrumb_enable : $smof_data['page_breadcrumbs'];
    if($breadcrumb_enable=='') $breadcrumb = $smof_data['page_breadcrumbs'];
    else $breadcrumb = $breadcrumb_enable; 
...
/** data parallax */
if(!empty($smof_data['page_title_bg_parallax']) && $smof_data['page_title_bg_parallax'] && !empty($smof_data['background-page-title']['media'])){

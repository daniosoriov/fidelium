...
?>
<?php if( !empty($smof_data['footer_top_widgets']) && $smof_data['footer_top_widgets'] == '1'){
/** data parallax */
$top_parallax = '';
$top_class = '';
...
<?php } ?>
<?php if( !empty($smof_data['footer_bottom_widgets']) && $smof_data['footer_bottom_widgets'] == '1'){ ?>

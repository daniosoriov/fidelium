...
$inline_css = ' style="' . vc_get_css_color( 'border-color', $accent_color ) .'border-width: '.esc_attr($border_width).'"';
...
if ( '' !== $title && 'separator_no_text' !== $layout ) {
	...
	$content .= '<'.esc_attr($heading_size).' class="title" style="color:'.$heading_font_color.'; font-size:'. $heading_font_size.';text-transform:'. $text_transform.';">' . $title . '</'.esc_attr($heading_size).'>';
}
